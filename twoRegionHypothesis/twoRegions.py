...
time_keyword2 = getDataFrame('anorexia','2020-04-05','2021-04-06', 'US-TX')
...
time2_keyword2_2020_21 = pd.DataFrame(
    {'Time': time2,
     'Anorexia 2020-2021 US-TX': keyword2,
    })

ax = time1_keyword1_2018_19.plot(x='Time', y='Anorexia 2018-2019 US-TX')
time2_keyword2_2020_21.plot(ax=ax, x='Time', y='Anorexia 2020-2021 US-TX')
