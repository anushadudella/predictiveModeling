...
# df = grangers_causation_matrix(results,['adhd','uscases'])

n_obs = 5
df_train, df_test = results[0:-n_obs], results[-n_obs:]
...
results_tr = df_train.diff().dropna()
adf_test(results_tr['adhd'])
adf_test(results_tr['uscases'])


# lag_order = results.k_ar
#
# df_input = results.values[-lag_order:]
