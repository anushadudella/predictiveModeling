...
# try:
#     time_keyword1 = getDataFrame(keyword2, date1, date2, geoparam)
#     # print(time_keyword1)
#     time_keyword2 = getDataFrame(keyword2, date3, date4, geoparam)
#     print(time_keyword2)
#
...
#     print(e.args)
#
# # time_keyword1 = getDataFrame('Depression','2020-04-04', '2021-04-06')
# # time_keyword2 = getDataFrame('Depression','2018-04-04', '2019-04-06')
# # ax = time_keyword1.plot(x='Time', y='Depression')
# # time_keyword2.plot(ax=ax, x='Time', y='Depression')
# #
#
