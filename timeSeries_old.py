...
plt.plot(df4, color="blue",label="Original Bulimia Data")
plt.plot(rolling_mean, color="red", label="Rolling Bulimia Mean")
plt.plot(rolling_std, color="black", label="Rolling Bulimia Standard Deviation")
# plt.show()

# #Predictive forecasting
# df4['Date'] = df4.index
# train = df4[df4['Date'] < pd.to_datetime("2024-08", format='%Y-%m')]
# train['train'] = train['bulimia']
# del train['Date']
# del train['bulimia']
# test = df4[df4['Date']] >= pd.to_datetime("2024-08", format='%Y-%m')
# del test['Date']
# test['test'] = test['bulimia']
# del test['bulimia']
# plt.plot(train, color = "black")
# plt.plot(test, color = "red")
# plt.title("Train/Test split for bulimia Data")
# plt.show()
